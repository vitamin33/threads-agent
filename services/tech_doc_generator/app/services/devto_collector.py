...
class DevToMetricsCollector:
    ...
    async def get_article_metrics(self, article_url: str) -> Dict[str, Any]:
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    if metrics["page_views_count"] > 0:
                        ...
                        metrics["engagement_rate"] = (total_engagements / metrics["page_views_count"]) * 100
                    else:
            ...
            logger.error(
                "devto_collection_failed",
                article_url=article_url,
                error=str(e)
            )
            return {"error": str(e)}
    
    async def get_user_articles_metrics(self, username: str, days_back: int = 30) -> List[Dict[str, Any]]:
                ...
                if response.status_code == 200:
                    ...
                    for article in articles:
                        ...
                        if published_at >= cutoff_date:
                            ...
                            article_metrics = await self.get_article_metrics(article["url"])
...
class DevToAchievementIntegration:
    ...
    async def sync_article_achievement(self, article_url: str, achievement_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        achievement_update = {
            ...
            "time_saved_hours": metrics.get("reading_time_minutes", 0) / 60,  # Convert to hours
        }
