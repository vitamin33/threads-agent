...
class AchievementContentGenerator:
    ...
    async def generate_from_achievement(
        ...
        try:
            ...
            logger.info("generating_content_from_achievement",
            ...
            for article_type in article_types:
                for platform in platforms:
                    ...
                    content.metadata["achievement_impact_score"] = achievement.impact_score
                    generated_content.append(content)
                    
            logger.info("content_generated_from_achievement",
                       achievement_id=achievement_id,
            ...
            logger.error("achievement_content_generation_failed",
                        achievement_id=achievement_id,
                        error=str(e))
            raise
    ...
    async def generate_weekly_highlights(
        ...
        try:
            ...
            logger.info("generating_weekly_highlights",
    ...
    async def generate_company_specific_content(
        ...
        company_profiles = {
            ...
            "jasper": {
                ...
                "article_types": [ArticleType.ARCHITECTURE_OVERVIEW, ArticleType.PERFORMANCE_OPTIMIZATION]
            },
            "anthropic": {
                "focus": ["ai-safety", "monitoring", "responsible-ai"],
                "platforms": [Platform.MEDIUM, Platform.GITHUB],
                "article_types": [ArticleType.BEST_PRACTICES, ArticleType.SECURITY_ANALYSIS]
            }
        }
        ...
        try:
            ...
            logger.info("company_specific_content_generated",
            ...
            logger.error("company_content_generation_failed",
                        company=company_name,
                        error=str(e))
            raise
            ...
            "key_insights": [
                {
                    ...
                    "description": achievement.business_value or achievement.description,
