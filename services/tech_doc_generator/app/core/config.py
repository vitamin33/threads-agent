...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = os.getenv("DATABASE_URL", "postgresql://user:pass@localhost:5432/threads_agent")
    ...
    supported_platforms: List[str] = ["devto", "linkedin", "twitter", "threads", "github", "medium"]
    
    # Scheduling settings
    default_publish_delay_hours: int = int(os.getenv("DEFAULT_PUBLISH_DELAY_HOURS", "2"))
