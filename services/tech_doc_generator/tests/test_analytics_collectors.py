...
class TestBaseAnalyticsCollector:
    ...
    def test_base_collector_has_required_methods(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import BaseAnalyticsCollector
...
class TestLinkedInAnalyticsCollector:
    ...
    def linkedin_collector(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import LinkedInAnalyticsCollector
        return LinkedInAnalyticsCollector(profile_id="vitaliiserbyn")

    @pytest.mark.asyncio
    async def test_get_profile_metrics_returns_expected_structure(self, linkedin_collector):
    ...
    @pytest.mark.asyncio
    async def test_get_conversion_data_tracks_serbyn_pro_visits(self, linkedin_collector):
...
class TestTwitterAnalyticsCollector:
    ...
    def twitter_collector(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import TwitterAnalyticsCollector
...
class TestMediumAnalyticsCollector:
    ...
    def medium_collector(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import MediumAnalyticsCollector
...
class TestGitHubAnalyticsCollector:
    ...
    def github_collector(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import GitHubAnalyticsCollector
...
class TestThreadsAnalyticsCollector:
    ...
    def threads_collector(self):
        ...
        from services.tech_doc_generator.app.services.analytics_collectors import ThreadsAnalyticsCollector
