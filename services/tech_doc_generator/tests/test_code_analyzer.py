...
class TestCodeAnalyzer:
    ...
    async def test_analyze_source_with_repository_type_calls_repository_analysis(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(analyzer, '_analyze_repository', return_value=expected_analysis):
...
def simple_function():
    return "hello"
            ...
            assert complex_func["docstring"] == "This is a complex function with documentation."
