...
class TestPostgreSQLEventStore:
    ...
    async def test_replay_events_by_timestamp_range(self):
        ...
        mock_rows = [
            {"event_id": "event-1", "timestamp": start_time + timedelta(minutes=10), "event_type": "user_created", "payload": '{"user_id": "123"}'},
            {"event_id": "event-2", "timestamp": start_time + timedelta(minutes=20), "event_type": "user_updated", "payload": '{"user_id": "123", "name": "John"}'},
            {"event_id": "event-3", "timestamp": start_time + timedelta(minutes=30), "event_type": "user_deleted", "payload": '{"user_id": "123"}'}
        ]
    ...
    async def test_replay_events_by_event_type(self):
        ...
        mock_rows = [
            {"event_id": "event-1", "timestamp": test_time, "event_type": "user_created", "payload": '{"user_id": "123"}'},
            {"event_id": "event-2", "timestamp": test_time, "event_type": "user_created", "payload": '{"user_id": "456"}'}
        ]
        mock_connection.fetch.return_value = mock_rows
    ...
    async def test_replay_events_with_limit(self):
        ...
        mock_rows = [
            {"event_id": "event-1", "timestamp": test_time, "event_type": "user_created", "payload": '{"user_id": "123"}'},
            {"event_id": "event-2", "timestamp": test_time, "event_type": "user_updated", "payload": '{"user_id": "123"}'}
        ]
        mock_connection.fetch.return_value = mock_rows
