...
class TestAsyncRabbitMQOptimization:
    ...
    async def test_connection_manager_has_async_connect_method(self):
        ...
        assert hasattr(manager, "connect_async"), (
            "RabbitMQConnectionManager should have a connect_async method"
        )
        assert hasattr(manager, "_async_connection"), (
            "Manager should have _async_connection attribute"
        )
    ...
    async def test_publisher_uses_async_operations(self):
        ...
        with patch.object(
            manager, "get_async_channel", return_value=mock_channel
        ) as mock_get_channel:
    ...
    def test_manager_has_async_attributes(self):
        ...
        assert manager._async_connection is None, (
            "Async connection should be None before initialization"
        )
