...
def upgrade() -> None:
    ...
    op.create_table('experiments',
        ...
        sa.Column('max_duration_hours', sa.Integer(), nullable=False, server_default='72'),
        ...
        sa.Column('posting_hours', sa.Text(), nullable=False, server_default='{"start": 9, "end": 21}'),
        
        # Results
        sa.Column('winner_variant_id', sa.Text(), nullable=True),
        sa.Column('significance_achieved', sa.Boolean(), nullable=False, server_default='false'),
    ...
    op.create_table('experiment_variants',
        ...
        sa.Column('impressions_total', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('engagements_total', sa.Integer(), nullable=False, server_default='0'),
    ...
    op.create_index('idx_exp_variant_experiment', 'experiment_variants', ['experiment_id'])
    ...
    op.create_index('idx_exp_variant_performance', 'experiment_variants', ['engagement_rate'])
