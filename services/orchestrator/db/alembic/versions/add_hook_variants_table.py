...
def upgrade() -> None:
    ...
    op.create_table('hook_variants',
        ...
        sa.Column('expected_engagement_rate', sa.Float(), nullable=False, server_default='0.0'),
        ...
        sa.Column('selected_for_posting', sa.Boolean(), nullable=False, server_default='false'),
    ...
    op.create_index('idx_performance', 'hook_variants', ['actual_engagement_rate'], postgresql_using='btree')
