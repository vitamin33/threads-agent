...
from services.orchestrator.db.models import Base, HookVariant, Experiment, ExperimentVariant
...
class StatisticalAnalyzer:
    ...
    def test_significance(
        ...
        se = np.sqrt(variant_rate * (1 - variant_rate) / variant_trials +
    ...
    def calculate_bayesian_probability(
        ...
        beta_c = control_metrics['impressions_total'] - control_metrics['engagements_total'] + 1
        
        # Beta parameters for variant
        alpha_v = variant_metrics['engagements_total'] + 1
        beta_v = variant_metrics['impressions_total'] - variant_metrics['engagements_total'] + 1
...
class ExperimentManager:
            ...
            for variant in variants:
                variant_stats = {
                    ...
                    'engagement_rate': (
                        ...
                        if variant.impressions_total > 0 else 0
                    )
                }
    ...
    def check_stopping_conditions(self, experiment_id: str) -> Optional[StoppingReason]:
        ...
        for variant in stats['variants']:
            if (variant['impressions'] > 50 and 
                variant['engagement_rate'] < 0.02):
