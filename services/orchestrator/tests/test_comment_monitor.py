...
class TestCommentMonitor:
    ...
    @pytest.fixture
    def comment_monitor(
        self, mock_fake_threads_client, mock_celery_client, mock_db_session
    ):
    ...
    def test_start_monitoring_calls_fake_threads_api(
        self, comment_monitor, mock_fake_threads_client
    ):
        """
    ...
    def test_comment_deduplication_prevents_duplicate_processing(
        self, comment_monitor, mock_db_session
    ):
        """
    ...
    def test_comments_queued_to_celery_for_intent_analysis(
        self, comment_monitor, mock_celery_client
    ):
        """
