...
class TestAchievementCollectorClientUnit:
    ...
    async def test_get_achievements_returns_mock_data(self):
        ...
        result = await client.get_achievements(category="development", min_impact_score=80.0)
...
class TestAchievementContentSelectorUnit:
    ...
    def test_select_top_achievements_filters_by_criteria(self):
        ...
        achievements = [
            ...
            {'id': 3, 'impact_score': 75.0, 'business_value': 8000.0},  # Below impact threshold
            {'id': 4, 'impact_score': 85.0, 'business_value': 1000.0}   # Below business value threshold
        ]
