...
from services.orchestrator.thompson_sampling import select_top_variants_with_engagement_predictor
...
class TestThompsonSamplingConvenience:
    ...
    def test_convenience_function_auto_imports_engagement_predictor(self):
        ...
        with patch('services.viral_engine.engagement_predictor.EngagementPredictor') as mock_predictor_class:
            mock_instance = Mock()
    ...
    def test_convenience_function_falls_back_on_import_error(self):
        ...
        # Mock import failure
        with patch('services.viral_engine.engagement_predictor.EngagementPredictor', 
