...
class TestContentManagementEndpoints:
    ...
    def test_create_content_item_returns_201_with_id(
        self, client, sample_content_item_data
    ):
    ...
    def test_create_content_item_requires_content(
        self, client, sample_content_item_data
    ):
    ...
    def test_get_content_by_id_returns_200_when_exists(
        self, client, sample_content_item_data
    ):
    ...
    def test_update_content_item_returns_200_with_updated_data(
        self, client, sample_content_item_data
    ):
...
class TestSchedulingManagementEndpoints:
    ...
    def test_create_schedule_returns_201_with_schedule_data(
        self, client, sample_content_item_data, sample_schedule_data
    ):
    ...
    def test_create_schedule_validates_content_exists(
        self, client, sample_schedule_data
    ):
    ...
    def test_create_schedule_validates_future_time(
        self, client, sample_content_item_data, sample_schedule_data
    ):
    ...
    def test_get_schedules_calendar_supports_date_range_filtering(self, client):
        ...
        response = client.get(
            f"/api/v1/schedules/calendar?start_date={start_date}&end_date={end_date}"
        )
    ...
    def test_update_schedule_returns_200_with_updated_data(
        self, client, sample_content_item_data, sample_schedule_data
    ):
...
class TestRealTimeStatusEndpoints:
    ...
    def test_get_content_status_returns_200_with_status_data(
        self, client, sample_content_item_data
    ):
...
class TestValidationAndErrorHandling:
    ...
    def test_invalid_platform_returns_422(
        self, client, sample_content_item_data, sample_schedule_data
    ):
...
class TestSchedulingManagementIntegration:
    ...
    def test_end_to_end_content_lifecycle(
        self, client, sample_content_item_data, sample_schedule_data
    ):
    ...
    def test_cascade_delete_schedules_when_content_deleted(
        self, client, sample_content_item_data, sample_schedule_data
    ):
    ...
    def test_concurrent_schedule_creation_for_same_content(
        self, client, sample_content_item_data, sample_schedule_data
    ):
