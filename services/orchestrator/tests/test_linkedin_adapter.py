...
class TestLinkedInAdapter:
    ...
    def test_linkedin_adapter_initialization(self):
        ...
        assert (
            adapter.supports_retry is False
        )  # Manual publishing doesn't support auto-retry
    ...
    async def test_linkedin_content_formatting(self, sample_content_item):
        ...
        assert any(
            ...
            for word in ["insights", "experience", "thoughts"]
        )
    ...
    def test_linkedin_content_length_optimization(self):
        ...
        long_content = (
            "This is a very long article. " * 200
        )  # Way too long for LinkedIn

        optimized_content = adapter._optimize_content_length(
            title="Test Article", content=long_content, max_length=3000
        )
