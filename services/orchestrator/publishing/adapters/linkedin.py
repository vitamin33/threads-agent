...
class LinkedInAdapter(PlatformAdapter):
    ...
    def _format_content_for_linkedin(self, content_item: ContentItem) -> str:
        ...
        if content_item.content_metadata and content_item.content_metadata.get("tags"):
            hashtags = self._format_hashtags_for_linkedin(content_item.content_metadata["tags"])
    ...
    def _optimize_content_length(self, title: str, content: str, max_length: int) -> str:
        ...
        if last_sentence_end > available_space * 0.7:  # If we can preserve at least 70% of content
