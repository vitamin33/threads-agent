...
# Database setup
POSTGRES_DSN = os.getenv("POSTGRES_DSN", "postgresql://postgres:pass@postgres:5432/postgres")
        ...
        with SessionLocal() as db:
            ...
            for row in result:
                ...
                posts.append(ContentItem(
                    ...
                    platforms=[Platform.DEV_TO, Platform.LINKEDIN],  # TODO: Add platform tracking
    ...
    try:
        ...
        for platform in platforms:
            if platform == Platform.DEV_TO:
                ...
                adapted_content.append(PlatformContent(
                    platform=platform,
                ...
                adapted_content.append(PlatformContent(
                    ...
                    hashtags=["#SoftwareDevelopment", "#TechLeadership", "#Programming"],
                ...
                adapted_content.append(PlatformContent(
                    platform=platform,
                    title=post.hook[:100] + "..." if len(post.hook) > 100 else post.hook,
                ...
                adapted_content.append(PlatformContent(
                    ...
                    hashtags=["programming", "software-development", "technology", "web-development"],
