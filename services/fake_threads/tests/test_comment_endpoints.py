...
class TestCommentEndpoints:
    ...
    def test_post_comment_creates_new_comment(self) -> None:
        ...
        """
        post_id = "post_123"
        comment_data = {"text": "Great post!", "author": "user1"}
    ...
    def test_get_comments_returns_created_comments(self) -> None:
        ...
        comment_data = {"text": "Amazing content!", "author": "user2"}
    ...
    def test_comments_are_isolated_by_post_id(self) -> None:
        ...
        client.post(
            f"/posts/{post_1}/comments", json={"text": "Comment 1", "author": "user1"}
        )

        # Create comment for post_2
        client.post(
            f"/posts/{post_2}/comments", json={"text": "Comment 2", "author": "user2"}
        )
