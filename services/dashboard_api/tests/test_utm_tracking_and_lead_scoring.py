...
class TestLeadScoringEngine:
    ...
    def test_calculate_lead_score_developer_vs_hiring_manager(self):
        ...
        assert hm_score.hiring_manager_probability > dev_score.hiring_manager_probability
...
class TestIntegratedConversionOptimization:
    ...
    def test_complete_conversion_flow_linkedin_to_job_inquiry(self):
        ...
        ab_test_result = ab_framework.create_ab_test([variant_a, variant_b], test_config)
        ab_assignment = ab_framework.assign_visitor_to_group(ab_test_result["test_id"], "visitor_123")
        ...
        conversion = ConversionEvent(
            ...
            visitor_id="visitor_123",
            timestamp=datetime.utcnow(),
            inquiry_details={"position": "Senior MLOps Engineer", "company": "TechCorp"}
        )
