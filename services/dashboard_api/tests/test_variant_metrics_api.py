...
class TestVariantMetricsAPI:
    ...
    def metrics_api(self, mock_db, mock_redis, mock_performance_monitor):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "services.dashboard_api.variant_metrics.PerformanceMonitor",
    ...
    async def test_get_live_metrics_returns_complete_structure(self, metrics_api):
        ...
        metrics_api.get_performance_summary = AsyncMock(
            return_value={"total_variants": 10}
        )
    ...
    @pytest.mark.asyncio
    async def test_get_active_variants_includes_live_performance(
        ...
        metrics_api.get_variant_performance = AsyncMock(
            return_value={"engagement_rate": 0.055, "views": 2000, "interactions": 110}
        )
    ...
    async def test_get_kill_statistics(self, metrics_api, mock_db):
        ...
        mock_db.fetch_one.return_value = {"total_kills": 5, "avg_time_to_kill": 3.5}
...
class TestWebSocketIntegration:
    ...
    async def test_websocket_sends_initial_data(self):
        ...
        with patch.object(ws_handler, "metrics_api") as mock_metrics_api:
            mock_metrics_api.get_live_metrics = AsyncMock(
                return_value={"summary": {"total_variants": 10}, "active_variants": []}
            )
