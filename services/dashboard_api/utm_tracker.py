...
class UTMParameterProcessor:
    ...
    def __init__(self):
        ...
        self.allowed_sources = {
            "linkedin", "devto", "medium", "twitter", "threads", 
            "github", "google", "direct", "email", "organic"
        }
    ...
    def validate_utm_parameters(self, utm_params: Dict[str, str]) -> bool:
        ...
        if utm_source and utm_source not in self.allowed_sources:
            raise UTMValidationError(f"Invalid utm_source: {utm_source}. Allowed: {self.allowed_sources}")
        
        return True
    
    def store_utm_analytics(self, utm_params: Dict[str, str], visitor_info: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_platform_analytics(self, platform: str) -> List[Dict[str, Any]]:
        ...
        return [
            record for record in self.analytics_store.values()
