...
class DashboardEventProcessor:
    ...
    async def handle_performance_update(self, variant_id: str, performance_data: Dict[str, Any]):
    ...
    async def handle_pattern_fatigue_alert(self, persona_id: str, fatigue_data: Dict[str, Any]):
    ...
    async def handle_optimization_alert(self, persona_id: str, optimization_data: Dict[str, Any]):
