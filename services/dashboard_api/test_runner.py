...
class DashboardTestRunner:
    ...
    def run_integration_tests(self, verbose: bool = False) -> Tuple[bool, float]:
        ...
        cmd = [
            ...
            "--durations=10",
            "-m",
            "not e2e",  # Exclude e2e tests from integration
            *[
                str(self.test_dir / f)
                for f in integration_test_files
                if (self.test_dir / f).exists()
            ],
        ]
    ...
    def run_e2e_tests(self, verbose: bool = False) -> Tuple[bool, float]:
        ...
        e2e_test_files = ["test_e2e_complete_dashboard.py", "test_e2e_dashboard.py"]
    ...
    def run_performance_tests(self, verbose: bool = False) -> Tuple[bool, float]:
        ...
        performance_test_files = ["test_edge_cases_and_performance.py"]
    ...
    def run_edge_case_tests(self, verbose: bool = False) -> Tuple[bool, float]:
        ...
        cmd = [
            ...
            "--durations=10",
            "-k",
            "edge_case or malformed or failure",
    ...
    def run_quick_tests(self, verbose: bool = False) -> int:
        ...
        cmd = [
            ...
            "--tb=short",
            "-k",
            "not (performance or stress or e2e)",
            str(self.test_dir),
        ]
