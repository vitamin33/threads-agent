    ...
    def _init_metrics(self):
        ...
        try:
            self.experiments_total = Counter(
                "chaos_experiments_total", "Total number of chaos experiments executed"
            )
        except ValueError:
            # Use existing metric
            ...
            for collector in REGISTRY._collector_to_names:
                if (
                    ...
                    and "chaos_experiments_total" in collector._name
                ):
        ...
        try:
            self.system_health_gauge = Gauge(
                "chaos_system_health_score", "Current system health score (0.0 to 1.0)"
            )
        except ValueError:
    ...
    async def execute_experiment(
        ...
        try:
            ...
            self.prometheus_client.observe(
                "chaos_experiment_duration_seconds", execution_time
            )
