...
class PortfolioGenerator:
    ...
    async def _generate_markdown(self, achievements: List[Achievement]) -> str:
        ...
        for category, items in by_category.items():
            ...
            for achievement in sorted(items, key=lambda x: x.impact_score, reverse=True):
                md_lines.extend([
                    f"#### {achievement.title}",
                    "",
                ...
                if achievement.skills_demonstrated:
                    md_lines.append(f"**Skills**: {', '.join(achievement.skills_demonstrated)}")
                    md_lines.append("")
    ...
    def _group_by_category(self, achievements: List[Achievement]) -> Dict[str, List[Achievement]]:
    ...
    def _calculate_stats(self, achievements: List[Achievement]) -> Dict:
        ...
        return {
            ...
            "avg_complexity": sum(a.complexity_score for a in achievements) / len(achievements),
            "by_category": {
                cat: len(items)
