...
class AchievementAnalyzer:
    ...
    async def _call_openai(self, prompt: str, json_mode: bool = False) -> str:
        ...
        if not self.api_key or self.api_key == "test":
            ...
            if json_mode:
                return json.dumps({
                    ...
                    "time_saved_hours": 20,
                    "recommendations": ["Continue optimization", "Document process"],
                })
        ...
        payload = {
            "model": self.model,
            "messages": [
                {"role": "system", "content": "You are a professional achievement analyst."},
    ...
    def _calculate_complexity_score(self, results: dict, achievement: Achievement) -> float:
    ...
    async def generate_portfolio_insights(self, achievements: List[Achievement]) -> List[str]:
        ...
        try:
            ...
            return ["Strong technical skills demonstrated", "Significant business impact achieved"]