...
class JSONExporter(BaseExporter):
    ...
    async def export(
        ...
        export_data = {
            ...
            "achievements": [
                self._serialize_achievement(a) for a in achievements
            ]
        }
    ...
    async def _generate_analytics(self, achievements: List) -> Dict[str, Any]:
        ...
        avg_complexity = sum(a.complexity_score or 0 for a in achievements) / len(achievements)
        ...
        return {
            ...
            "timeline": {
                "earliest": min(a.completed_at for a in achievements if a.completed_at).isoformat(),
                "latest": max(a.completed_at for a in achievements if a.completed_at).isoformat()
            }
        }
