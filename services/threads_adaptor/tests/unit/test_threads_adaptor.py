...
from services.threads_adaptor.main import app, PostRequest, EngagementMetrics
...
class TestListPublished:
    ...
    def test_list_published(self, mock_session, client, mock_env):
        ...
        mock_db = Mock()
        mock_db.query.return_value.order_by.return_value.limit.return_value.all.return_value = [mock_post]
        mock_session.return_value = mock_db
