...
class PostPurchaseHandler(BaseStateHandler):
    ...
    def analyze_message(self, message: str, context: ConversationContext) -> Dict[str, Any]:
        ...
        positive_keywords = [
            "love", "amazing", "awesome", "great", "fantastic",
            "working well", "perfect", "thanks", "appreciate"
        ]
        
        # Issue indicators
        issue_keywords = [
            "problem", "issue", "not working", "help", "stuck",
            "confused", "error", "broken", "wrong", "can't"
        ]
        
        # Support needs
        support_keywords = [
            "how do i", "where is", "can't find", "show me",
            "tutorial", "guide", "documentation", "training"
        ]
        
        # Success indicators
        success_keywords = [
            "results", "roi", "saved", "earned", "improved",
            "increased", "better", "growth", "win"
        ]
        ...
        return {
            ...
            "engagement_type": "support" if has_issues else "success" if reporting_success else "general"
        }
    ...
    def _handle_immediate_post_purchase(self, analysis: Dict[str, Any], params: Dict[str, Any]) -> str:
    ...
    def _handle_onboarding(self, analysis: Dict[str, Any], params: Dict[str, Any]) -> str:
    ...
    def _handle_activation(self, analysis: Dict[str, Any], params: Dict[str, Any]) -> str:
    ...
    def _handle_success_check(self, analysis: Dict[str, Any], params: Dict[str, Any]) -> str:
    ...
    def _handle_ongoing_relationship(self, analysis: Dict[str, Any], params: Dict[str, Any]) -> str:
