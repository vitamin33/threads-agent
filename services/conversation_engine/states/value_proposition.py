...
class ValuePropositionHandler(BaseStateHandler):
    ...
    async def handle(self, context: ConversationContext) -> StateResponse:
        ...
        return StateResponse(
            ...
            metadata={
                ...
                "objections_raised": analysis["objection_type"] if analysis["has_objections"] else None
            }
        )
    ...
    def analyze_message(self, message: str, context: ConversationContext) -> Dict[str, Any]:
        ...
        # Buying signals
        buying_keywords = [
            "sign up", "let's do it", "i'm in", "ready", "start",
            "how do i", "what's next", "let's go", "sounds good",
            "perfect", "exactly what i need"
        ]
        
        # Proof request signals
        proof_keywords = [
            "proof", "evidence", "results", "case study", "testimonial",
            "who else", "examples", "show me", "demonstrate"
        ]
    ...
    def _provide_social_proof(self, pain_point: str, params: Dict[str, Any]) -> str:
        ...
        return proof_templates.get(pain_point, 
    ...
    def _calculate_roi_message(self, pain_point: str, params: Dict[str, Any]) -> str:
        ...
        return roi_templates.get(pain_point,
