...
class ClosingAttemptHandler(BaseStateHandler):
    ...
    async def handle(self, context: ConversationContext) -> StateResponse:
        ...
        if analysis["purchase_confirmed"]:
            ...
            message = self._handle_last_minute_objection(
                analysis["objection_type"], params
            )
    ...
    def _handle_last_minute_objection(
        self, objection_type: str, params: Dict[str, Any]
    ) -> str:
    ...
    def _provide_reassurance(
        self, params: Dict[str, Any], context: ConversationContext
    ) -> str:
