...
from services.conversation_engine.memory import (
    ConversationMemorySystem, ConversationMemory, ConversationStateDB, ConversationTurnDB
)
...
class TestConversationMemorySystem:
    ...
    async def test_add_conversation_turn(self, memory_system, sample_memory):
        ...
        assert retrieved.conversation_turns[0]["user_message"] == "I'm interested in your product"
