...
class PersonalizationEngine:
    ...
    def _build_prompt(self, request: PersonalizationRequest) -> str:
        ...
        recent_history = request.conversation_history[-5:] if request.conversation_history else []
        history_text = "\n".join([
...
Generate ONLY the message text, nothing else:"""
    ...
    async def analyze_user_style(self, messages: List[str]) -> Dict[str, Any]:
        ...
        formal_indicators = ["dear", "regards", "sincerely", "would you", "could you", "please"]
    ...
    def generate_fallback_response(self, state: str, context: Dict[str, Any]) -> str:
        ...
        return fallbacks.get(state, "Thanks for your message! How can I help you today?")