...
async def analyze_content(request: AnalysisRequest):
    ...
    try:
        ...
        if any(word in content.lower() for word in ["amazing", "incredible", "shocking"]):
...
async def get_trending_patterns():
    ...
    return {
        "patterns": [
            {"name": "question_hooks", "score": 0.85, "examples": ["Did you know...?", "What if I told you...?"]},
            {"name": "controversy", "score": 0.78, "examples": ["Unpopular opinion:", "This might trigger you..."]},
            {"name": "storytelling", "score": 0.72, "examples": ["Last week, something crazy happened...", "I used to think..."]}
        ],
