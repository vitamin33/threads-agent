...
class BusinessMetricsCollector:
    ...
    def record_current_performance(self, rps: float, latency_ms: float, success_rate: float):
    ...
    def calculate_business_impact(self, development_cost: float = 25000) -> BusinessImpact:
        ...
        rps_improvement = (self.current_metrics.requests_per_second / 
                          self.baseline_metrics.requests_per_second) - 1
        
        latency_improvement = (self.baseline_metrics.avg_latency_ms - 
                              self.current_metrics.avg_latency_ms) / self.baseline_metrics.avg_latency_ms
