...
class TestPerformanceRegressionDetectorBasics:
    ...
    def test_performance_regression_detector_initialization(self):
        ...
        assert detector.statistical_tests == [StatisticalTest.T_TEST, StatisticalTest.MANN_WHITNEY]
    ...
    def test_detect_regression_with_significant_drop(self, sample_historical_data, sample_current_data):
    ...
    def test_detect_regression_with_no_significant_change(self):
        ...
        assert result.p_value > 0.05
        assert abs(result.effect_size) < 0.15  # Small effect size (allowing for some randomness)
...
class TestPerformanceRegressionDetectorStatisticalTests:
    ...
    def test_t_test_detects_regression(self, regression_detector, clear_regression_data):
    ...
    def test_mann_whitney_detects_regression(self, regression_detector, clear_regression_data):
    ...
    def test_multiple_tests_consensus(self, regression_detector, clear_regression_data):
        ...
        significant_tests = [
            test for test, details in result.test_results.items()
...
class TestPerformanceRegressionDetectorMetricTypes:
    ...
    def test_latency_metric_regression_detection(self):
        ...
        assert result.is_regression is True
        assert result.effect_size > 0  # Positive because latency increased (current > historical)
...
class TestPerformanceRegressionDetectorAdvancedFeatures:
    ...
    def test_confidence_intervals_calculation(self):
        ...
        assert result.baseline_confidence_interval[0] < result.baseline_confidence_interval[1]
