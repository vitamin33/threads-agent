...
class TestAIMetricsTracker:
    ...
    def test_record_inference_error(self):
        ...
        # Record an error
        tracker.record_inference(
            model_name="gpt-4", tokens_used=0, response_time_ms=100, error=True
        )
    ...
    def test_cost_calculation(self):
        ...
        # Test GPT-4 pricing
        cost_gpt4 = tracker._calculate_cost(
            "gpt-4", prompt_tokens=1000, completion_tokens=1000
        )
        expected_gpt4 = (1000 * 0.03 + 1000 * 0.06) / 1000  # $0.09
        assert abs(cost_gpt4 - expected_gpt4) < 0.001

        # Test GPT-3.5-turbo pricing
        cost_gpt35 = tracker._calculate_cost(
            "gpt-3.5-turbo", prompt_tokens=1000, completion_tokens=1000
        )
    ...
    def test_percentile_calculations(self):
        ...
        for rt in response_times:
            tracker.record_inference(
                model_name="gpt-3.5-turbo", tokens_used=100, response_time_ms=rt
            )
