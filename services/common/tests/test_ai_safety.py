...
class TestAISecurityMonitor:
    ...
    def test_hallucination_flagging(self):
        ...
        assert any(
            "financial" in f["category"] for f in financial_result["risk_factors"]
        )
    ...
    def test_security_metrics_tracking(self):
        ...
        assert (
            metrics["total_security_checks"] == 2
        )  # Only prompt injection increments total_checks
    ...
    def test_hallucination_recommendations(self):
        ...
        assert (
            ...
            in financial_result["recommendation"]
        )
