...
class TestGradualRolloutManagerFailureInjection:
    ...
    def test_rollout_resilience_to_detector_timeout(self, failing_performance_detector):
        ...
        failing_performance_detector.detect_regression.side_effect = TimeoutError("Timeout")
    ...
    def test_rollout_blocks_on_network_failures(self, failing_performance_detector):
        ...
        failing_performance_detector.detect_regression.side_effect = ConnectionError("Network error")
    ...
    def test_rollout_recovery_after_intermittent_failures(self, failing_performance_detector):
        ...
        def intermittent_failure(*args, **kwargs):
            ...
            if intermittent_failure.call_count <= 3:
                raise RuntimeError(f"Intermittent failure #{intermittent_failure.call_count}")
            return Mock(is_regression=False, p_value=0.8)
        
        failing_performance_detector.detect_regression.side_effect = intermittent_failure
        ...
        assert any(r.success for r in results), "Should recover from intermittent failures"
    ...
    def test_memory_pressure_during_rollout(self, failing_performance_detector):
        ...
        for i in range(10000):  # Large dataset
            large_historical_data.append(Mock(
        ...
        failing_performance_detector.detect_regression.side_effect = MemoryError("Out of memory")
    ...
    def test_data_corruption_detection_during_rollout(self, failing_performance_detector):
        ...
        failing_performance_detector.detect_regression.side_effect = ValueError("Corrupted data")
...
class TestGradualRolloutManagerConcurrencyAndRaceConditions:
    ...
    def test_concurrent_stage_advancement_safety(self):
        ...
        assert len(successful_advances) <= 4  # Maximum possible advances from CANARY_10 to FULL_ROLLOUT
    ...
    def test_rollout_state_consistency_under_load(self):
        ...
        assert final_status.traffic_percentage == final_status.current_stage.traffic_percentage
...
class TestGradualRolloutManagerRecoveryScenarios:
    ...
    def test_rollout_timeout_handling_and_recovery(self):
        ...
        manager = GradualRolloutManager(detector, stage_timeout_minutes=1)  # 1 minute timeout
    ...
    def test_rollout_rollback_on_consecutive_failures(self):
        ...
        detector = Mock()
        detector.detect_regression.return_value = Mock(is_regression=True, p_value=0.001)
