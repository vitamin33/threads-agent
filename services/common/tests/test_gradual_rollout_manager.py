...
class TestGradualRolloutManagerBasics:
    ...
    def test_gradual_rollout_manager_initialization_requires_performance_detector(self):
        ...
        """
        from services.common.gradual_rollout_manager import GradualRolloutManager, RolloutError
...
class TestGradualRolloutProgression:
    ...
    def test_monitor_deployment_health_integration(self):
        ...
        """
        from services.common.gradual_rollout_manager import GradualRolloutManager, DeploymentHealth
...
class TestRolloutStatusAndReporting:
    ...
    def test_get_rollout_status_provides_current_state(self):
        ...
        """
        from services.common.gradual_rollout_manager import GradualRolloutManager, RolloutStatus, RolloutStage
    ...
    def test_rollout_result_contains_comprehensive_info(self):
        ...
        result_attributes = [
            'success', 'stage', 'traffic_percentage', 'error_message',
            'timestamp', 'health_metrics', 'duration'
        ]
