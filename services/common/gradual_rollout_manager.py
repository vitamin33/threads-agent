...
class GradualRolloutManager:
    ...
    def advance_stage(self, historical_data: List[Any] = None, current_data: List[Any] = None) -> RolloutResult:
        """
    ...
    def monitor_deployment_health(
        ...
        metric_name = historical_data[0].metric_name if historical_data else "performance_metric"
