...
class AIInfraConfig:
    ...
    def __init__(self):
        ...
        self.model_registry_uri = os.getenv(
            "MODEL_REGISTRY_URI",
            "http://mlflow:5000"
        )
        
        # Vector Database Configuration (Qdrant, Pinecone, Weaviate)
        self.vector_db_url = os.getenv(
            "VECTOR_DB_URL",
            "http://qdrant:6333"
        )
        
        # GPU Resource Management
        self.gpu_memory_fraction = float(os.getenv(
            "GPU_MEMORY_FRACTION",
            "0.8"
        ))
        ...
        self.feature_store_url = os.getenv(
            "FEATURE_STORE_URL",
            "http://feast:6565"
        )
    ...
    def get_kubernetes_resources(self, workload_type: str = "inference") -> Dict[str, Any]:
        """
    ...
    def validate_config(self) -> bool:
        ...
        validations.append(self.cost_optimization["min_replicas"] <= self.cost_optimization["max_replicas"])
