...
class RollbackController:
    ...
    def start_monitoring(self, current_model: str, fallback_model: str) -> RollbackResult:
        """
    ...
    def check_health(
        ...
        try:
            ...
            metric_name = historical_data[0].metric_name if historical_data else "deployment_health"
    ...
    def _execute_rollback(self, trigger: RollbackTrigger, reason: str) -> RollbackResult:
        """
