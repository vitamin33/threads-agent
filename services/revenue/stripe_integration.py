...
from services.common.metrics import record_business_metric, update_revenue_projection
...
class RevenueManager:
        ...
        if not customer:
            ...
            try:
                stripe_customer = stripe.Customer.create(
                    email=email, name=name, metadata={"source": "threads_agent"}
                )
    ...
    def create_subscription(
        ...
        try:
            ...
            update_revenue_projection("subscription", float(tier_config["price"]))
    ...
    def get_subscription_status(self, subscription_id: int) -> Optional[Dict]:
