            ...
            for platform, platform_result in result['result']['platforms'].items():
                if platform_result.get('success'):
                    ...
                    if platform == 'devto':
                        ...
                        print(f"         Instructions: {platform_result.get('message')}")
...
async def main():
    ...
    parser.add_argument("--check", action="store_true", help="Check platform configuration")
    parser.add_argument("--publish", action="store_true", help="Run publishing workflow")
    parser.add_argument("--live", action="store_true", help="Publish live (not test mode)")
