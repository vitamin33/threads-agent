        ...
        try:
            ...
            with urllib.request.urlopen(request) as response:
                if response.status in [200, 201]:
                    ...
                    print(f"  ✅ Created achievement #{result['id']} for PR #{pr_data['pr_number']}")
                    return True
                else:
...
def import_from_analysis_file(filename: str):
    ...
    if 'top_achievements' in data:
        ...
        for i, achievement in enumerate(achievements):
            ...
            business_value = {
                ...
                'cost_savings': achievement.get('cost_savings', achievement['value'] * 0.7),
                'productivity_hours': achievement.get('productivity_hours', achievement['value'] / 150),
    ...
    # For full analysis format  
        ...
        high_value_prs = [
            ...
            if pr_num in business_values and business_values[pr_num]['portfolio_value'] > 10000
        ]
