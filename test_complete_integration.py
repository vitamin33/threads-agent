...
async def test_complete_integration():
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            ...
            test_response = await client.get(f"{achievement_url}/tech-doc-integration/content-ready")
        ...
        list_resp = await client.get(f"{achievement_url}/achievements/", params={"limit": 5})
        ...
        if achievements:
            ...
            print(f"   Would generate {len(article_request['article_types'])} x {len(article_request['platforms'])} = {len(article_request['article_types']) * len(article_request['platforms'])} articles")
        ...
        stats_resp = await client.get(f"{achievement_url}/tech-doc-integration/stats/content-opportunities")
        if stats_resp.status_code == 200:
            ...
            if stats['total_content_ready'] > 0:
                potential_articles = stats['total_content_ready'] * 3  # Average 3 articles per achievement
